<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1" import="it.contrader.dto.BambinoDTO"
...
<body style="background-color: #6495ed;">
	...
	<div class="divPrincipale">
		...
		<div class="divBottoni">
			<button class="bottoneprova">
				<a href="/parametro/rileva?idbambino=<%=parametro.getIdbambino()%>">Quanto
					peso</a>
			</button>
			<button class="bottoneprova">
				<a href="/parametro/rileva?idbambino=<%=parametro.getIdbambino()%>">Dimmi
					perche piangi</a>
			</button>
			<button class="bottoneprova">
				<a href="/parametro/rileva?idbambino=<%=parametro.getIdbambino()%>">Misurami
					la frebre</a>
			</button>
			<button class="bottoneprova">
				<a href="/parametro/rileva?idbambino=<%=parametro.getIdbambino()%>">Controllami
					il pannolino</a>
			</button>
		</div>
		...
		<div class="divImg">
			<img alt=""
				src="https://media.istockphoto.com/vectors/baby-babbling-cute-baby-milestone-vector-id906874436?k=20&m=906874436&s=612x612&w=0&h=gzupGk4nAQgh6AGq-Q41bFlFwR0S4sct6CvEzCpCXe4="
				class="imgPrincipale">
		</div>
		<nav class="main-menu">
			<ul>
				<li><a href="http://justinfarrow.com"> <i
						class="fa fa-home fa-2x"></i> <span class="nav-text">
							Battito Cardiaco <br>
							<h1 class="parametri"><%=parametro.getBattito()%>
							</h1>
					</span>
				</a></li>
				<li class="has-subnav"><a href="#"> <i
						class="fa fa-laptop fa-2x"></i> <span class="nav-text">
							Saturazione <br>
							<h1 class="parametri"><%=parametro.getSaturazione()%>
							</h1>
				...
				<li class="has-subnav"><a href="#"> <i
						class="fa fa-list fa-2x"></i> <span class="nav-text">
							Temperatura <br>
							<h1 class="parametri temperatura"><%=parametro.getTemperatura()%>
							</h1>
					</span>
				</a></li>
				<li class="has-subnav"><a href="#"> <i
						...
						style=""> Peso <br>
							<h1 class="parametri"><%=parametro.getPeso()%>
							</h1>

					</span>
				</a></li>
				<li><a href="#"> <i class="fa fa-bar-chart-o fa-2x"></i> <span
						class="nav-text"> Stress <br>
							<h1 class="parametri"><%=parametro.getStress()%>
							</h1>
